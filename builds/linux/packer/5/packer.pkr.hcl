...
/*
    DESCRIPTION:
    Packer toolbox server: VMware Photon OS 5 with the tooling needed to work with this
...
source "vsphere-iso" "linux-packer-photon" {
...
build {
  sources = ["source.vsphere-iso.linux-packer-photon"]
